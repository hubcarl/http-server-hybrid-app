package com.smart.app.vendor.pulldownrefresh;
...
import com.smart.app.vendor.pulldownrefresh.indicator.PtrIndicator;
import com.smart.app.vendor.pulldownrefresh.util.PtrCLog;
 ...
 * It defines {@link com.smart.app.vendor.pulldownrefresh.PtrUIHandler}, which allows you customize the UI easily.
 */
public class PtrFrameLayout extends ViewGroup {
    ...
    public void setContentView(View contentView) {
        ...
        if (lp == null) {
            lp = new ViewGroup.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
